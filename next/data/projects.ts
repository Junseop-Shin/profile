    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "서비스마다 올리는 법이 다르면 배포 스크립트도 서비스 수만큼 생긴다. 통일해두니 스크립트가 하나로 줄었고, 관측 스택에서 로그를 걷을 때도 같은 자리에서 걷게 됐다",
      ...
      },
      {
        ...
        items: [
          "프론트엔드, 공통 API 서버, 관측 스택의 게이트웨이와 에이전트, MQTT 브로커, MongoDB, API Management까지 이 방식으로 올라간다",
